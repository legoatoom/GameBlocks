...
public class PawnPromotionWidget extends DrawableHelper implements Drawable, Element, Selectable {
    ...
    public static class PawnPromotionChooseButtonWidget extends TexturedButtonWidget {
        ...
        private final AbstractBoardScreen screen;
        private final Item item;

        public PawnPromotionChooseButtonWidget(AbstractBoardScreen abstractBoardScreen, IChessPieceItem chessPiece, int x, int y, int width, int height, int u, int v, int hoveredVOffset, Identifier texture, int textureWidth, int textureHeight, PressAction pressAction) {
